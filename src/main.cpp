...
uint256 hashGenesisBlock("0x4ac6a48f08e36df631c79a5929c687f22958f8ce92d199f077cbf4db77feeb00");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // VegasCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "VegasCoin Signed Message:\n";
...
{
    // VegasCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired_V1(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // VegasCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
void ThreadScriptCheck() {
    RenameThread("vegascoin-scriptch");
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // VegasCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // VegasCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x525fefa347d20b2050f386373bbbd2df65cf01731fe2555b7ceff8fec87eb1a3");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        //   vMerkleTree: 97ddfbbae6
          ...
          // Genesis block
        const char* pszTimestamp = "cnn.com 2014-02-11 - I didn't mean to kill, 'It just worked out that way'";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1392172369;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2893208;

        if (fTestNet)
        {
            block.nTime    = 1392163921;
            block.nNonce   = 1283003;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x3f5f95df1e8ba364df188ce3a5a5c4aa27d579272d4eb3f8cc1904a88cba872f"));
        block.print();
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("VegasCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("VegasCoinMiner : ProcessBlock, block not accepted");
    }
