    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new VegascoinUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->vegascoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting VegasCoin."), QMessageBox::Ok);
