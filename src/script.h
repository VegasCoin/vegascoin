...
#ifndef H_VEGASCOIN_SCRIPT
#define H_VEGASCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CVegascoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Vegascoin always counted CHECKMULTISIGs
