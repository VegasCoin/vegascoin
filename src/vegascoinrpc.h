...
#ifndef _VEGASCOINRPC_H_
#define _VEGASCOINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Vegascoin is not connected
...
/**
 * Vegascoin RPC command dispatcher.
 */
class CRPCTable
{
private:
