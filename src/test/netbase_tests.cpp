...
{
    BOOST_CHECK(TestSplitHost("www.vegascoin.co", "www.vegascoin.co", -1));
    BOOST_CHECK(TestSplitHost("[www.vegascoin.co]", "www.vegascoin.co", -1));
    BOOST_CHECK(TestSplitHost("www.vegascoin.co:80", "www.vegascoin.co", 80));
    BOOST_CHECK(TestSplitHost("[www.vegascoin.co]:80", "www.vegascoin.co", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:52400", "127.0.0.1", 7912));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:7912", "127.0.0.1", 7912));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:7912", "::ffff:127.0.0.1", 7912));
    BOOST_CHECK(TestSplitHost("[::]:7912", "::", 7912));
    BOOST_CHECK(TestSplitHost("::7912", "::7912", -1));
    BOOST_CHECK(TestSplitHost(":7912", "", 7912));
    BOOST_CHECK(TestSplitHost("[]:7912", "", 7912));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:52400", "127.0.0.1:52400"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:7912", "[::]:7912"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
