...
unlocked to sign the Vegascoin-Qt.app bundle.
...
allowing somebody to distribute a Vegascoin-Qt.app or vegascoin-qt-setup.exe with a valid
...
that the vegascoin-qt.exe file inside the installer had not been tampered with.
